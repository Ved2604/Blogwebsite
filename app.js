...
app.get("/",function(req,res){
  ...
  res.render("home",{pagecontent:homeStartingContent,Blogs:Posts,});
...
{  var storedtitle=Posts[i].title;
  storedtitle=_.lowerCase(storedtitle);
   if(storedtitle===match)
        res.render("post",{Blogtit:Posts[i].title,Blogpo:Posts[i].blogpost})}
})
